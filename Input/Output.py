...
logger = DatabricksLogger(meta_data={"source": source_name, "sourcetype": f"databricks:{source_type}", "host": databricks_host})
...
def logging_wrapper(task, error_msg):
    def inner(func):
        ...
        return wrapper
    return inner
# ... (rest of the code remains unchanged, business logic preserved) ...
import atexit
