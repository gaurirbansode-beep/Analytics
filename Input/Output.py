...
# Commented Splunk logger initialization and replaced with Databricks logger
...
# Use Databricks logger as per reference
logger = logger  # Assuming logger is initialized in databricks_logger
...
# ... (rest of the code remains unchanged except for logger usage)
